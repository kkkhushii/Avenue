  ...
  return (
    <div className=' py-[30px]'>
        <div className='container max-w-[1200px] mx-auto '>
              <h2 className='font-bold text-[38px] text-customcol font-customFont pb-[30px]'>Top Destinations</h2>
                ...
                <div className='w-1/2'>
                    <div className='flex mb-[30px] relative'>
                        ...
                        <div className='absolute bottom-0 p-[53px]'>
                            <h4 className=''>Hiking Adventure</h4>
                            <p className=''>306 Destinations</p>
                        </div>
